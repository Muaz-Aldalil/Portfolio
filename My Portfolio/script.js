(function () {
    ...
    contactForm.addEventListener("submit", function (e) {
      ...
      fetch(contactForm.getAttribute("action"), {
        ...
        .then(function () {
          ...
          btn.innerHTML =
            '<span>Message Sent! <i class="fas fa-check"></i></span>';
          contactForm.reset();
          setTimeout(function () {
            btn.classList.remove("sent");
            btn.disabled = false;
            btn.innerHTML =
              '<span class="btn-text">Send Message</span><i class="fas fa-paper-plane"></i><span class="btn-loading"><i class="fas fa-spinner fa-spin"></i> Sending...</span>';
          }, 3000);
        })
        .catch(function () {
          btn.classList.remove("loading");
  ...
  window.addEventListener("load", function () {
    ...
    if (
      heroStats &&
      heroStats.getBoundingClientRect().top < window.innerHeight
    ) {
      animateHeroCounters();
    }
  });
